...
export function MainLayout({
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden font-sans selection:bg-primary/30">
          ...
          {userEmail && (
            <>
              ...
              <button
                ...
                className="p-1.5 rounded-lg border border-white/10 text-muted-foreground hover:text-foreground hover:bg-white/10 transition-colors"
              >
      ...
      <NotificationPreferencesPanel open={showPrefs} onClose={() => setShowPrefs(false)} />
    </div>
  )
}
